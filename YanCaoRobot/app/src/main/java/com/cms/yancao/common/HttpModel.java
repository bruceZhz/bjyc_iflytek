...
public class HttpModel {
    public static  final String prefix = "http://192.168.43.60:8080/showimage.do?name=";
    ...
    public static Observable<JSONObject> loadAnswer(String robot, String content) {
        String url = "http://192.168.43.60:8080/robot/getAnswer";
    ...
    public static Observable<JSONObject> loadConfig(String robotId){
        String url = "http://192.168.43.60:8080/robot/getRobotInfoByRobotID";
        RequestBody body = new FormBody.Builder()
                .add("robotID", robotId)
                .build();
        final Request request = new Request.Builder().url(url).post(body).build();
